...
export const wheelChecklistDataDumpTruck: ChecklistSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        field: "structurePinSpringSteeringTrunion",
        label: "Check & lubricate Pin Spring, Steering likage & Trunion",
        type: "result",
      },
      {
        field: "structureMountingRubberTorqueRod",
        label: "Check Mounting & Rubber Torque Rod",
        type: "result",
      },
      {
        field: "structureSpringUBolt",
      ...
      {
        field: "structureBallJointTieRod",
        label: "Check ball joint tie rod",
        type: "result",
      },
      {
        field: "structureBallJointDragLink",
        label: "Check ball joint drag link",
        type: "result",
      },
      {
        field: "structureShockAbsorber",
        label: "Check Shock Absorber",
        type: "result",
      },
      {
        field: "structureTyreBoltPressure",
        label: "Check Tyre, Bolt Tyre & Tyre Pressure",
        type: "result",
      },
      {
        field: "structureRubberHollowspring",
  ...
  },
  {
    ...
    fields: [
      {
        field: "attachmentDumpBodyVessel",
        label: "Check Dump Body, Pin, Pad, Stabilizer, tail gate & vesel",
        type: "result",
      },
      {
        field: "attachmentSafetyDumpFunction",
        label: "Check Safety Dump Function",
        type: "result",
      },
      {
        field: "greaseCentralGrease",
        label: "Check Cental Grease",
        type: "result",
      },
      {
        field: "greaseAllPointsArea",
